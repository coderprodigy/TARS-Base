...
def record_audio(ask=" how are you"):
...
# def record_userInput(feedback):
#     print(feedback)
#     text_data=input("Enter the desired Command \n")
#     print(">>", text_data.lower()) # print what user wants
...
def respond(voice_data):
    ...
    if there_exists(["game"]):
        ...
        # voice_data = record_userInput("choose among rock paper or scissor")
    ...
    if there_exists(["definition of"]):
        ...
        # definition=record_userInput("what do you need the definition of")
